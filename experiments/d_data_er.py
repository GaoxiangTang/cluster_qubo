...
#         res_random = hybrid_qubo_solve(qubo_matrix, max_qubit_size=qubit_size, group_method='random')
#         res_pool = hybrid_qubo_solve(qubo_matrix, max_qubit_size=qubit_size, group_method='pool')
...
#     with open('100er_d_data.pkl', 'wb') as file:
